    ...
    <body>
        ...
        try {
            ...
            <form method="get" action="resultats.php">
                ...
                <!--Recherche-->
                <input type="text" name="recherche" id="recherche" placeholder="Rechercher" maxlength="60" onkeyup="remplir(this.value)"/>            <input type="submit" value="Rechercher" click="doublons(event)">
                    <br />
                    ...
                    <select name="pays" id="pays">
                        ...
                        while ($donnees = $reponse->fetch()) {
                            ?>
                            <option id="<?php echo $donnees['id_pays']; ?>" value="<?php echo $donnees['nom_pays'] ?>"> <?php echo $donnees['nom_pays'] ?></option>
                            <?php
                        }
                    ...
                    <!--Code Postal-->
                    <input type="text" name="cd" placeholder="Code postal" maxlength="5" id="cd" onKeyPress="return scanToucheCodePostal(event);"/>
                    ...
                    <select name="type" id="type">
                        ...
                        while ($donnees = $reponse->fetch()) {
                            ?>
                            <option id="<?php echo $donnees['id_type']; ?>" value="<?php echo $donnees['nom_type'] ?>"> <?php echo $donnees['nom_type'] ?></option>
                            <?php
                        }
                        $reponse->closeCursor(); // Termine le traitement de la requ�te
                        ?>
